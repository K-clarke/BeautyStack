 ...
 */
final class Version20190529232410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE style (id INT AUTO_INCREMENT NOT NULL, tag_id INT DEFAULT NULL, picture LONGTEXT NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, time DATETIME NOT NULL, INDEX IDX_33BDB86ABAD26311 (tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
